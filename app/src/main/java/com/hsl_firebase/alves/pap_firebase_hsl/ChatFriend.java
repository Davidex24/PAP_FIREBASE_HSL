...
public class ChatFriend extends AppCompatActivity implements View.OnClickListener {
    ...
    /*//String that get name of friend
    private String mChatUser;

    //Varaibles for toolbar
    private Toolbar mChatToolbar;
    private TextView mTitleView;
    private TextView mLastSeenView;
    private CircleImageView mProfileImage;

    //Firebase variables and string to get database Reference
    private FirebaseAuth mAuth;
    private String mCurrentUserId;
    private DatabaseReference mRootRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //To check and warn if user are Online or Offline
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(online.equals("true")){
                    ...
                    //Get the time that user are offline
                    GetTimeAgo getTimeAgo = new GetTimeAgo();
                    long lastTime = Long.parseLong(online);
                    String lastTimeOnline = getTimeAgo.getTimeAgo(lastTime, getApplicationContext());
                    //Show how much time user are offline
                    mLastSeenView.setText(lastTimeOnline);
    ...
    //Method to send message to a friend
